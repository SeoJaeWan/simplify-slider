...
describe("Move 테스트", () => {
  ...
  it("Move 생성 시 slidesPerView를 2로 설정하면 goToIndex()로 변경해도 화면에서 나누는 값만큼 이동한다.", () => {
    const move = new Move(wrapper, duration, 2);
    move.goToIndex(2);
